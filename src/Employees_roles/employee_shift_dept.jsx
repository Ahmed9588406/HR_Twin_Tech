...
const EmployeeShiftDept = () => {
  ...
  useEffect(() => {
    const fetchShiftDeptData = async () => {
      try {
        ...
        const url = `https://noneffusive-reminiscent-tanna.ngrok-free.dev/api/v1/emp-dashboard/employee-shift-dept`;
    ...
    return (
      <div className="bg-white rounded-2xl shadow-lg p-6 mt-6 border border-slate-200">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Loading shift/dept info...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-slate-200 mt-6">
